...
public class OrnamenticSearchEntry extends AbstractSearchEntry {
	 ...
	 * @param sessionID
	 */
	public OrnamenticSearchEntry(boolean orSearch, String sessionID) {
	 ...
	 * @param sessionID
	 */
	public OrnamenticSearchEntry(String sessionID) {
		super(sessionID);
	}
	...
	/**
	 * @param secondarypatterns
	 *          the secondarypatterns to set
	 */
	...
	/**
	 * @param relatedOrnaments
	 *          the relatedOrnaments to set
	 */
	 ...
	 *          the position to set
	 */
	public void setImageIDList(ArrayList<Integer> imageIDs) {
