...
public class CoordinateEntry extends AbstractEntry {
	...
	public CoordinateEntry(int positionID, String name) {
		this.positionID = positionID;
		this.name = name;
	}
	public CoordinateEntry(int positionID, int depictionID, String name, Integer register, Integer number, boolean exact) {
		this.positionID = positionID;
...
//	}
    ...
    public boolean equals(Object anObject) {
    	...
    	if (anObject instanceof CoordinateEntry){
        	if (this.getPositionID()==((CoordinateEntry)anObject).getPositionID()) {
        		isEqual=true;
        	}
    	}
        return isEqual;
