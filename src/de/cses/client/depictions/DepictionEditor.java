...
//	}
	...
	private void initPanel() {
		...
		attributePanel.setHeading("Cave");
		...
		vendorSelection
				.select(vendorEntryList.findModelWithKey(Integer.toString(correspondingDepictionEntry.getVendorID())));
		...
		vp.setSize("350", "300");
		attributePanel = new FramedPanel();
		attributePanel.setHeading("Images");
