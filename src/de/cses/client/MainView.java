...
public class MainView implements IsWidget {
	...
	private static final String FOOTER_TEXT = "\u00A9 2019 Sächsische Akademie der Wissenschaften zu Leipzig (Version 1.1)";
...
//	private DataDisplayController dataDisplayController;
    ...
    ornamenticActiveTB.addSelectHandler(new SelectHandler() {
		...
		ornamenticSearchController = new OrnamenticSearchController("Typical Picture", new OrnamenticFilter("Typical Pictures"), new OrnamenticResultView("Typical Pictures"), ornamenticInactiveTB, ornamenticActiveTB);
