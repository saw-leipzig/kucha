...
public class ImageUploader implements IsWidget {
	...
	private void initPanel() {
		...
		form = new FormPanel();
		form.setAction("testapplication/imgUploader");
...
//				MessageBox box = new MessageBox("File uploaded", "<html>" + resultHtml + "</html>");
//				box.setIcon(MessageBox.ICONS.info());
//				box.show();
	      Info.display("Upload file", "finished");
	    }
	  });
		
		form.add(new FieldLabel(file, "file"), new MarginData(15));
