...
public class StaticTables {
	...
	public StaticTables(ListsLoadedListener l) {
		...
		loadCounter = 21;
		loadDistricts();
		Util.doLogging("StaticTable 1");
		loadSites();
		Util.doLogging("StaticTable 2");
		loadRegions();
		Util.doLogging("StaticTable 3");
		loadCaveTypes();
		Util.doLogging("StaticTable 4");
		loadCeilingTypes();
		Util.doLogging("StaticTable 5");
		loadPreservationClassification();
		Util.doLogging("StaticTable 6");
		loadImageTypes();
		Util.doLogging("StaticTable 7");
		loadExpeditions();
		Util.doLogging("StaticTable 8");
		loadStyles();
		Util.doLogging("StaticTable 9");
		loadIconography();
		Util.doLogging("StaticTable 10");
		loadIconographyForOrnamentic();
		Util.doLogging("StaticTable 11");
		loadModesOfRepresentation();
		Util.doLogging("StaticTable 12");
		loadWallLocations();
		Util.doLogging("StaticTable 13");
		loadOrnamentPositionTable();
		Util.doLogging("StaticTable 14");
		loadOrnamentFunctionTable();
		Util.doLogging("StaticTable 15");
		loadLocationMap();
		Util.doLogging("StaticTable 16");
		loadVendor();
		Util.doLogging("StaticTable 17");
		loadPublicationTypes();
		Util.doLogging("StaticTable 18");
		loadBiliography();
		Util.doLogging("StaticTable 19");
		loadCaves();
		Util.doLogging("StaticTable 20");
		loadOrientation();
		Util.doLogging("StaticTable 21");
		loadWallEntries();
		Util.doLogging("StaticTable 22");
		loadPositionTable();
		Util.doLogging("StaticTable 23");
	}
