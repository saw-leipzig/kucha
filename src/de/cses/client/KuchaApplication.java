...
import de.cses.client.caves.CaveEditorListener;
 ...
 */
public class KuchaApplication implements EntryPoint, ImageEditorListener {
	...
	protected CaveEntry selectedCaveEntry=null;
...
//				selectedCaveEntry = event.getSelectedItem();
//			}
//		});
//
...
//				CaveEditor ced = new CaveEditor(selectedCaveEntry, new CaveEditorListener() {
//					
//					@Override
...
//					}
//				});
//				caveEditorPanel.add(ced.asWidget());
